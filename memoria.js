...
const imagens = ['./img_Helena/maria_clara_jp_1.jpg', './img_Helena/maria_clara_jp_2.jpg', 
'./img_Helena/princesa_1.jpg', './img_Helena/princesa_2.jpg', './img_Helena/princesa_3.jpg', 
'./img_Helena/santa_edwiges.jpg'];
 
for (let i = 1; i <= 8; i++) imagens.push(`../JOGUINHO_HELENA/id/${i}/100`);
 
let fundo = `./img_Helena/capa_princesa.jpg`;
...
onload = () => {
    ...
    document.body.style.backgroundImage = "url('./img_Helena/background_5.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('.titulo').textContent ='Parabéns HELENA!';
    document.querySelector('.titulo').style.backgroundColor ='#FF0000';  
    document.querySelector('#matematica').style.backgroundColor = '#FF0000';   
    document.body.style.backgroundImage = "url('./img_Helena/background_7.jpg')";
    timerDoJogo.stop();
